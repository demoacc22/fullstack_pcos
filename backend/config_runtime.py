...
GENDER_LABELS_FILE = os.getenv(
    "GENDER_LABELS_FILE",
    str(BASE_DIR / "models" / "face" / "gender.labels.txt")
)
...
GENDER_CALIBRATION_CACHE = os.getenv(
    "GENDER_CALIBRATION_CACHE",
    str(BASE_DIR / "models" / "face" / ".gender_calibration.json")
)
